...
// source: dfuse/zswhq/trxdb/v1/trxdb.proto
...
func init() {
	proto.RegisterEnum("dfuse.zswhq.trxdb.v1.IndexableCategory", IndexableCategory_name, IndexableCategory_value)
	proto.RegisterType((*ImplicitTrxRow)(nil), "dfuse.zswhq.trxdb.v1.ImplicitTrxRow")
	proto.RegisterType((*TrxRow)(nil), "dfuse.zswhq.trxdb.v1.TrxRow")
	proto.RegisterType((*TrxTraceRow)(nil), "dfuse.zswhq.trxdb.v1.TrxTraceRow")
	proto.RegisterType((*DtrxRow)(nil), "dfuse.zswhq.trxdb.v1.DtrxRow")
	proto.RegisterType((*BlockRow)(nil), "dfuse.zswhq.trxdb.v1.BlockRow")
	proto.RegisterType((*AccountRow)(nil), "dfuse.zswhq.trxdb.v1.AccountRow")
}

func init() {
	proto.RegisterFile("dfuse/zswhq/trxdb/v1/trxdb.proto", fileDescriptor_014579ff7d302fea)
}
