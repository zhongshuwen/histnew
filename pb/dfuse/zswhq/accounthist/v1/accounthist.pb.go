...
// source: dfuse/zswhq/accounthist/v1/accounthist.proto
...
import (
	context "context"
	fmt "fmt"
	v1 "github.com/zhongshuwen/histnew/pb/dfuse/zswhq/codec/v1"
...
func init() {
	proto.RegisterType((*GetActionsRequest)(nil), "dfuse.zswhq.accounthist.v1.GetActionsRequest")
	proto.RegisterType((*GetTokenActionsRequest)(nil), "dfuse.zswhq.accounthist.v1.GetTokenActionsRequest")
	proto.RegisterType((*ActionResponse)(nil), "dfuse.zswhq.accounthist.v1.ActionResponse")
	proto.RegisterType((*ActionRow)(nil), "dfuse.zswhq.accounthist.v1.ActionRow")
	proto.RegisterType((*ShardCheckpoint)(nil), "dfuse.zswhq.accounthist.v1.ShardCheckpoint")
	proto.RegisterType((*ActionRowAppend)(nil), "dfuse.zswhq.accounthist.v1.ActionRowAppend")
	proto.RegisterType((*Cursor)(nil), "dfuse.zswhq.accounthist.v1.Cursor")
}

func init() {
	proto.RegisterFile("dfuse/zswhq/accounthist/v1/accounthist.proto", fileDescriptor_4c22ddb60199ece6)
}
...
func (c *accountHistoryClient) GetActions(ctx context.Context, in *GetActionsRequest, opts ...grpc.CallOption) (AccountHistory_GetActionsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_AccountHistory_serviceDesc.Streams[0], "/dfuse.zswhq.accounthist.v1.AccountHistory/GetActions", opts...)
	if err != nil {
		return nil, err
	}
...
var _AccountHistory_serviceDesc = grpc.ServiceDesc{
	ServiceName: "dfuse.zswhq.accounthist.v1.AccountHistory",
	...
	Metadata: "dfuse/zswhq/accounthist/v1/accounthist.proto",
}
...
func (c *accountContractHistoryClient) GetAccountContractActions(ctx context.Context, in *GetTokenActionsRequest, opts ...grpc.CallOption) (AccountContractHistory_GetAccountContractActionsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_AccountContractHistory_serviceDesc.Streams[0], "/dfuse.zswhq.accounthist.v1.AccountContractHistory/GetAccountContractActions", opts...)
	if err != nil {
		return nil, err
	}
...
var _AccountContractHistory_serviceDesc = grpc.ServiceDesc{
	ServiceName: "dfuse.zswhq.accounthist.v1.AccountContractHistory",
