...
// source: dfuse/zswhq/codec/v1/codec.proto
...
type TransactionReceipt struct {
	...
	Status               TransactionStatus  `protobuf:"varint,1,opt,name=status,proto3,enum=dfuse.zswhq.codec.v1.TransactionStatus" json:"status,omitempty"`
...
type TransactionLifecycle struct {
	Id                      string              `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	TransactionStatus       TransactionStatus   `protobuf:"varint,2,opt,name=transaction_status,json=transactionStatus,proto3,enum=dfuse.zswhq.codec.v1.TransactionStatus" json:"transaction_status,omitempty"`
...
type TrxOp struct {
	Operation            TrxOp_Operation    `protobuf:"varint,1,opt,name=operation,proto3,enum=dfuse.zswhq.codec.v1.TrxOp_Operation" json:"operation,omitempty"`
	Name                 string             `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
...
type DBOp struct {
	Operation            DBOp_Operation `protobuf:"varint,1,opt,name=operation,proto3,enum=dfuse.zswhq.codec.v1.DBOp_Operation" json:"operation,omitempty"`
...
type KVOp struct {
	...
	Operation KVOp_Operation `protobuf:"varint,1,opt,name=operation,proto3,enum=dfuse.zswhq.codec.v1.KVOp_Operation" json:"operation,omitempty"`
...
type RAMOp struct {
	...
	Operation   RAMOp_Operation `protobuf:"varint,1,opt,name=operation,proto3,enum=dfuse.zswhq.codec.v1.RAMOp_Operation" json:"operation,omitempty"`
	ActionIndex uint32          `protobuf:"varint,2,opt,name=action_index,json=actionIndex,proto3" json:"action_index,omitempty"`
	...
	Namespace RAMOp_Namespace `protobuf:"varint,6,opt,name=namespace,proto3,enum=dfuse.zswhq.codec.v1.RAMOp_Namespace" json:"namespace,omitempty"`
	// Namespace representing the action the RAM operation did, like
	// add, delete or remove an object.
	//
	// This coupled with `action` replaces the `operation` field.
	Action RAMOp_Action `protobuf:"varint,7,opt,name=action,proto3,enum=dfuse.zswhq.codec.v1.RAMOp_Action" json:"action,omitempty"`
...
type TableOp struct {
	Operation            TableOp_Operation `protobuf:"varint,1,opt,name=operation,proto3,enum=dfuse.zswhq.codec.v1.TableOp_Operation" json:"operation,omitempty"`
	ActionIndex          uint32            `protobuf:"varint,2,opt,name=action_index,json=actionIndex,proto3" json:"action_index,omitempty"`
	Payer                string            `protobuf:"bytes,3,opt,name=payer,proto3" json:"payer,omitempty"`
...
type DTrxOp struct {
	Operation            DTrxOp_Operation   `protobuf:"varint,1,opt,name=operation,proto3,enum=dfuse.zswhq.codec.v1.DTrxOp_Operation" json:"operation,omitempty"`
	ActionIndex          uint32             `protobuf:"varint,2,opt,name=action_index,json=actionIndex,proto3" json:"action_index,omitempty"`
...
type PermOp struct {
	Operation            PermOp_Operation  `protobuf:"varint,1,opt,name=operation,proto3,enum=dfuse.zswhq.codec.v1.PermOp_Operation" json:"operation,omitempty"`
	ActionIndex          uint32            `protobuf:"varint,2,opt,name=action_index,json=actionIndex,proto3" json:"action_index,omitempty"`
...
type RlimitOp struct {
	Operation RlimitOp_Operation `protobuf:"varint,1,opt,name=operation,proto3,enum=dfuse.zswhq.codec.v1.RlimitOp_Operation" json:"operation,omitempty"`
...
func init() {
	proto.RegisterEnum("dfuse.zswhq.codec.v1.BlockReversibility", BlockReversibility_name, BlockReversibility_value)
	proto.RegisterEnum("dfuse.zswhq.codec.v1.TransactionStatus", TransactionStatus_name, TransactionStatus_value)
	proto.RegisterEnum("dfuse.zswhq.codec.v1.TrxOp_Operation", TrxOp_Operation_name, TrxOp_Operation_value)
	proto.RegisterEnum("dfuse.zswhq.codec.v1.DBOp_Operation", DBOp_Operation_name, DBOp_Operation_value)
	proto.RegisterEnum("dfuse.zswhq.codec.v1.KVOp_Operation", KVOp_Operation_name, KVOp_Operation_value)
	proto.RegisterEnum("dfuse.zswhq.codec.v1.RAMOp_Operation", RAMOp_Operation_name, RAMOp_Operation_value)
	proto.RegisterEnum("dfuse.zswhq.codec.v1.RAMOp_Namespace", RAMOp_Namespace_name, RAMOp_Namespace_value)
	proto.RegisterEnum("dfuse.zswhq.codec.v1.RAMOp_Action", RAMOp_Action_name, RAMOp_Action_value)
	proto.RegisterEnum("dfuse.zswhq.codec.v1.TableOp_Operation", TableOp_Operation_name, TableOp_Operation_value)
	proto.RegisterEnum("dfuse.zswhq.codec.v1.DTrxOp_Operation", DTrxOp_Operation_name, DTrxOp_Operation_value)
	proto.RegisterEnum("dfuse.zswhq.codec.v1.FeatureOp_Kind", FeatureOp_Kind_name, FeatureOp_Kind_value)
	proto.RegisterEnum("dfuse.zswhq.codec.v1.PermOp_Operation", PermOp_Operation_name, PermOp_Operation_value)
	proto.RegisterEnum("dfuse.zswhq.codec.v1.RlimitOp_Operation", RlimitOp_Operation_name, RlimitOp_Operation_value)
	proto.RegisterType((*Block)(nil), "dfuse.zswhq.codec.v1.Block")
	proto.RegisterType((*BlockWithRefs)(nil), "dfuse.zswhq.codec.v1.BlockWithRefs")
	proto.RegisterType((*TransactionRefs)(nil), "dfuse.zswhq.codec.v1.TransactionRefs")
	proto.RegisterType((*ActivatedProtocolFeatures)(nil), "dfuse.zswhq.codec.v1.ActivatedProtocolFeatures")
	proto.RegisterType((*PendingProducerSchedule)(nil), "dfuse.zswhq.codec.v1.PendingProducerSchedule")
	proto.RegisterType((*ProducerSchedule)(nil), "dfuse.zswhq.codec.v1.ProducerSchedule")
	proto.RegisterType((*ProducerKey)(nil), "dfuse.zswhq.codec.v1.ProducerKey")
	proto.RegisterType((*ProducerAuthoritySchedule)(nil), "dfuse.zswhq.codec.v1.ProducerAuthoritySchedule")
	proto.RegisterType((*ProducerAuthority)(nil), "dfuse.zswhq.codec.v1.ProducerAuthority")
	proto.RegisterType((*BlockSigningAuthority)(nil), "dfuse.zswhq.codec.v1.BlockSigningAuthority")
	proto.RegisterType((*BlockSigningAuthorityV0)(nil), "dfuse.zswhq.codec.v1.BlockSigningAuthorityV0")
	proto.RegisterType((*BlockRootMerkle)(nil), "dfuse.zswhq.codec.v1.BlockRootMerkle")
	proto.RegisterType((*ProducerToLastProduced)(nil), "dfuse.zswhq.codec.v1.ProducerToLastProduced")
	proto.RegisterType((*ProducerToLastImpliedIRB)(nil), "dfuse.zswhq.codec.v1.ProducerToLastImpliedIRB")
	proto.RegisterType((*TransactionReceipt)(nil), "dfuse.zswhq.codec.v1.TransactionReceipt")
	proto.RegisterType((*PackedTransaction)(nil), "dfuse.zswhq.codec.v1.PackedTransaction")
	proto.RegisterType((*BlockHeader)(nil), "dfuse.zswhq.codec.v1.BlockHeader")
	proto.RegisterType((*TransactionEvent)(nil), "dfuse.zswhq.codec.v1.TransactionEvent")
	proto.RegisterType((*TransactionEvent_AddedInternally)(nil), "dfuse.zswhq.codec.v1.TransactionEvent.AddedInternally")
	proto.RegisterType((*TransactionEvent_Added)(nil), "dfuse.zswhq.codec.v1.TransactionEvent.Added")
	proto.RegisterType((*TransactionEvent_Executed)(nil), "dfuse.zswhq.codec.v1.TransactionEvent.Executed")
	proto.RegisterType((*TransactionEvent_DtrxScheduled)(nil), "dfuse.zswhq.codec.v1.TransactionEvent.DtrxScheduled")
	proto.RegisterType((*TransactionEvent_DtrxCanceled)(nil), "dfuse.zswhq.codec.v1.TransactionEvent.DtrxCanceled")
	proto.RegisterType((*PublicKeys)(nil), "dfuse.zswhq.codec.v1.PublicKeys")
	proto.RegisterType((*TransactionLifecycle)(nil), "dfuse.zswhq.codec.v1.TransactionLifecycle")
	proto.RegisterType((*SignedTransaction)(nil), "dfuse.zswhq.codec.v1.SignedTransaction")
	proto.RegisterType((*Transaction)(nil), "dfuse.zswhq.codec.v1.Transaction")
	proto.RegisterType((*TransactionHeader)(nil), "dfuse.zswhq.codec.v1.TransactionHeader")
	proto.RegisterType((*TransactionTrace)(nil), "dfuse.zswhq.codec.v1.TransactionTrace")
	proto.RegisterType((*TransactionReceiptHeader)(nil), "dfuse.zswhq.codec.v1.TransactionReceiptHeader")
	proto.RegisterType((*Action)(nil), "dfuse.zswhq.codec.v1.Action")
	proto.RegisterType((*ActionTrace)(nil), "dfuse.zswhq.codec.v1.ActionTrace")
	proto.RegisterType((*ActionReceipt)(nil), "dfuse.zswhq.codec.v1.ActionReceipt")
	proto.RegisterType((*AuthSequence)(nil), "dfuse.zswhq.codec.v1.AuthSequence")
	proto.RegisterType((*AccountRAMDelta)(nil), "dfuse.zswhq.codec.v1.AccountRAMDelta")
	proto.RegisterType((*AccountDelta)(nil), "dfuse.zswhq.codec.v1.AccountDelta")
	proto.RegisterType((*Extension)(nil), "dfuse.zswhq.codec.v1.Extension")
	proto.RegisterType((*TrxOp)(nil), "dfuse.zswhq.codec.v1.TrxOp")
	proto.RegisterType((*DBOp)(nil), "dfuse.zswhq.codec.v1.DBOp")
	proto.RegisterType((*KVOp)(nil), "dfuse.zswhq.codec.v1.KVOp")
	proto.RegisterType((*RAMOp)(nil), "dfuse.zswhq.codec.v1.RAMOp")
	proto.RegisterType((*RAMCorrectionOp)(nil), "dfuse.zswhq.codec.v1.RAMCorrectionOp")
	proto.RegisterType((*TableOp)(nil), "dfuse.zswhq.codec.v1.TableOp")
	proto.RegisterType((*DTrxOp)(nil), "dfuse.zswhq.codec.v1.DTrxOp")
	proto.RegisterType((*ExtDTrxOp)(nil), "dfuse.zswhq.codec.v1.ExtDTrxOp")
	proto.RegisterType((*FeatureOp)(nil), "dfuse.zswhq.codec.v1.FeatureOp")
	proto.RegisterType((*CreationFlatNode)(nil), "dfuse.zswhq.codec.v1.CreationFlatNode")
	proto.RegisterType((*PermOp)(nil), "dfuse.zswhq.codec.v1.PermOp")
	proto.RegisterType((*PermissionObject)(nil), "dfuse.zswhq.codec.v1.PermissionObject")
	proto.RegisterType((*Permission)(nil), "dfuse.zswhq.codec.v1.Permission")
	proto.RegisterType((*Authority)(nil), "dfuse.zswhq.codec.v1.Authority")
	proto.RegisterType((*KeyWeight)(nil), "dfuse.zswhq.codec.v1.KeyWeight")
	proto.RegisterType((*PermissionLevel)(nil), "dfuse.zswhq.codec.v1.PermissionLevel")
	proto.RegisterType((*PermissionLevelWeight)(nil), "dfuse.zswhq.codec.v1.PermissionLevelWeight")
	proto.RegisterType((*WaitWeight)(nil), "dfuse.zswhq.codec.v1.WaitWeight")
	proto.RegisterType((*RlimitOp)(nil), "dfuse.zswhq.codec.v1.RlimitOp")
	proto.RegisterType((*RlimitState)(nil), "dfuse.zswhq.codec.v1.RlimitState")
	proto.RegisterType((*RlimitConfig)(nil), "dfuse.zswhq.codec.v1.RlimitConfig")
	proto.RegisterType((*RlimitAccountLimits)(nil), "dfuse.zswhq.codec.v1.RlimitAccountLimits")
	proto.RegisterType((*RlimitAccountUsage)(nil), "dfuse.zswhq.codec.v1.RlimitAccountUsage")
	proto.RegisterType((*UsageAccumulator)(nil), "dfuse.zswhq.codec.v1.UsageAccumulator")
	proto.RegisterType((*ElasticLimitParameters)(nil), "dfuse.zswhq.codec.v1.ElasticLimitParameters")
	proto.RegisterType((*Ratio)(nil), "dfuse.zswhq.codec.v1.Ratio")
	proto.RegisterType((*Exception)(nil), "dfuse.zswhq.codec.v1.Exception")
	proto.RegisterType((*Exception_LogMessage)(nil), "dfuse.zswhq.codec.v1.Exception.LogMessage")
	proto.RegisterType((*Exception_LogContext)(nil), "dfuse.zswhq.codec.v1.Exception.LogContext")
	proto.RegisterType((*Feature)(nil), "dfuse.zswhq.codec.v1.Feature")
	proto.RegisterType((*SubjectiveRestrictions)(nil), "dfuse.zswhq.codec.v1.SubjectiveRestrictions")
	proto.RegisterType((*Specification)(nil), "dfuse.zswhq.codec.v1.Specification")
	proto.RegisterType((*AccountCreationRef)(nil), "dfuse.zswhq.codec.v1.AccountCreationRef")
}

func init() {
	proto.RegisterFile("dfuse/zswhq/codec/v1/codec.proto", fileDescriptor_3286b8d338e80dff)
}
