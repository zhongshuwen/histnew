...
// source: dfuse/zswhq/funnel/v1/funnel.proto
...
func init() {
	proto.RegisterType((*StreamBlockRequest)(nil), "dfuse.zswhq.funnel.v1.StreamBlockRequest")
	proto.RegisterType((*StreamBlockResponse)(nil), "dfuse.zswhq.funnel.v1.StreamBlockResponse")
}

func init() {
	proto.RegisterFile("dfuse/zswhq/funnel/v1/funnel.proto", fileDescriptor_477a415e0c40d59c)
}
...
func (c *funnelClient) StreamBlocks(ctx context.Context, in *StreamBlockRequest, opts ...grpc.CallOption) (Funnel_StreamBlocksClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Funnel_serviceDesc.Streams[0], "/dfuse.zswhq.funnel.v1.Funnel/StreamBlocks", opts...)
	if err != nil {
		return nil, err
	}
...
var _Funnel_serviceDesc = grpc.ServiceDesc{
	ServiceName: "dfuse.zswhq.funnel.v1.Funnel",
	...
	Metadata: "dfuse/zswhq/funnel/v1/funnel.proto",
}
