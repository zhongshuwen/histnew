...
// source: dfuse/zswhq/tokenmeta/v1/tokenmeta.proto
...
type GetTokensRequest struct {
	...
	SortOrder            SortOrder                  `protobuf:"varint,2,opt,name=sort_order,json=sortOrder,proto3,enum=dfuse.zswhq.tokenmeta.v1.SortOrder" json:"sort_order,omitempty"`
	SortField            GetTokensRequest_SortField `protobuf:"varint,3,opt,name=sort_field,json=sortField,proto3,enum=dfuse.zswhq.tokenmeta.v1.GetTokensRequest_SortField" json:"sort_field,omitempty"`
	SecondarySortOrder   SortOrder                  `protobuf:"varint,8,opt,name=secondary_sort_order,json=secondarySortOrder,proto3,enum=dfuse.zswhq.tokenmeta.v1.SortOrder" json:"secondary_sort_order,omitempty"`
	SecondarySortField   GetTokensRequest_SortField `protobuf:"varint,9,opt,name=secondary_sort_field,json=secondarySortField,proto3,enum=dfuse.zswhq.tokenmeta.v1.GetTokensRequest_SortField" json:"secondary_sort_field,omitempty"`
...
type GetAccountBalancesRequest struct {
	...
	SortOrder            SortOrder                           `protobuf:"varint,3,opt,name=sort_order,json=sortOrder,proto3,enum=dfuse.zswhq.tokenmeta.v1.SortOrder" json:"sort_order,omitempty"`
	SortField            GetAccountBalancesRequest_SortField `protobuf:"varint,4,opt,name=sort_field,json=sortField,proto3,enum=dfuse.zswhq.tokenmeta.v1.GetAccountBalancesRequest_SortField" json:"sort_field,omitempty"`
	SecondarySortOrder   SortOrder                           `protobuf:"varint,10,opt,name=secondary_sort_order,json=secondarySortOrder,proto3,enum=dfuse.zswhq.tokenmeta.v1.SortOrder" json:"secondary_sort_order,omitempty"`
	SecondarySortField   GetAccountBalancesRequest_SortField `protobuf:"varint,11,opt,name=secondary_sort_field,json=secondarySortField,proto3,enum=dfuse.zswhq.tokenmeta.v1.GetAccountBalancesRequest_SortField" json:"secondary_sort_field,omitempty"`
	FilterTokenContracts []string                            `protobuf:"bytes,5,rep,name=filter_token_contracts,json=filterTokenContracts,proto3" json:"filter_token_contracts,omitempty"`
	...
	Options              []GetAccountBalancesRequest_Option  `protobuf:"varint,9,rep,packed,name=options,proto3,enum=dfuse.zswhq.tokenmeta.v1.GetAccountBalancesRequest_Option" json:"options,omitempty"`
...
type GetTokenBalancesRequest struct {
	...
	Limit                uint32                            `protobuf:"varint,2,opt,name=limit,proto3" json:"limit,omitempty"`
	SortOrder            SortOrder                         `protobuf:"varint,3,opt,name=sort_order,json=sortOrder,proto3,enum=dfuse.zswhq.tokenmeta.v1.SortOrder" json:"sort_order,omitempty"`
	SortField            GetTokenBalancesRequest_SortField `protobuf:"varint,4,opt,name=sort_field,json=sortField,proto3,enum=dfuse.zswhq.tokenmeta.v1.GetTokenBalancesRequest_SortField" json:"sort_field,omitempty"`
	SecondarySortOrder   SortOrder                         `protobuf:"varint,10,opt,name=secondary_sort_order,json=secondarySortOrder,proto3,enum=dfuse.zswhq.tokenmeta.v1.SortOrder" json:"secondary_sort_order,omitempty"`
	SecondarySortField   GetTokenBalancesRequest_SortField `protobuf:"varint,11,opt,name=secondary_sort_field,json=secondarySortField,proto3,enum=dfuse.zswhq.tokenmeta.v1.GetTokenBalancesRequest_SortField" json:"secondary_sort_field,omitempty"`
	...
	Options              []GetTokenBalancesRequest_Option  `protobuf:"varint,9,rep,packed,name=options,proto3,enum=dfuse.zswhq.tokenmeta.v1.GetTokenBalancesRequest_Option" json:"options,omitempty"`
	BeforeCursor         *AccountBalanceCursor             `protobuf:"bytes,7,opt,name=before_cursor,json=beforeCursor,proto3" json:"before_cursor,omitempty"`
	AfterCursor          *AccountBalanceCursor             `protobuf:"bytes,8,opt,name=after_cursor,json=afterCursor,proto3" json:"after_cursor,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                          `json:"-"`
	XXX_unrecognized     []byte                            `json:"-"`
...
func init() {
	proto.RegisterEnum("dfuse.zswhq.tokenmeta.v1.SortOrder", SortOrder_name, SortOrder_value)
	proto.RegisterEnum("dfuse.zswhq.tokenmeta.v1.GetTokensRequest_SortField", GetTokensRequest_SortField_name, GetTokensRequest_SortField_value)
	proto.RegisterEnum("dfuse.zswhq.tokenmeta.v1.GetAccountBalancesRequest_SortField", GetAccountBalancesRequest_SortField_name, GetAccountBalancesRequest_SortField_value)
	proto.RegisterEnum("dfuse.zswhq.tokenmeta.v1.GetAccountBalancesRequest_Option", GetAccountBalancesRequest_Option_name, GetAccountBalancesRequest_Option_value)
	proto.RegisterEnum("dfuse.zswhq.tokenmeta.v1.GetTokenBalancesRequest_SortField", GetTokenBalancesRequest_SortField_name, GetTokenBalancesRequest_SortField_value)
	proto.RegisterEnum("dfuse.zswhq.tokenmeta.v1.GetTokenBalancesRequest_Option", GetTokenBalancesRequest_Option_name, GetTokenBalancesRequest_Option_value)
	proto.RegisterType((*GetTokensRequest)(nil), "dfuse.zswhq.tokenmeta.v1.GetTokensRequest")
	proto.RegisterType((*TokensResponse)(nil), "dfuse.zswhq.tokenmeta.v1.TokensResponse")
	proto.RegisterType((*Token)(nil), "dfuse.zswhq.tokenmeta.v1.Token")
	proto.RegisterType((*GetAccountBalancesRequest)(nil), "dfuse.zswhq.tokenmeta.v1.GetAccountBalancesRequest")
	proto.RegisterType((*AccountBalancesResponse)(nil), "dfuse.zswhq.tokenmeta.v1.AccountBalancesResponse")
	proto.RegisterType((*GetTokenBalancesRequest)(nil), "dfuse.zswhq.tokenmeta.v1.GetTokenBalancesRequest")
	proto.RegisterType((*TokenBalancesResponse)(nil), "dfuse.zswhq.tokenmeta.v1.TokenBalancesResponse")
	proto.RegisterType((*TokenContractBalancesResponse)(nil), "dfuse.zswhq.tokenmeta.v1.TokenContractBalancesResponse")
	proto.RegisterType((*AccountBalance)(nil), "dfuse.zswhq.tokenmeta.v1.AccountBalance")
	proto.RegisterType((*TransactionCursor)(nil), "dfuse.zswhq.tokenmeta.v1.TransactionCursor")
	proto.RegisterType((*TokenCursor)(nil), "dfuse.zswhq.tokenmeta.v1.TokenCursor")
	proto.RegisterType((*AccountBalanceCursor)(nil), "dfuse.zswhq.tokenmeta.v1.AccountBalanceCursor")
}

func init() {
	proto.RegisterFile("dfuse/zswhq/tokenmeta/v1/tokenmeta.proto", fileDescriptor_acfa679eff1c5edb)
}
...
func (c *tokenMetaClient) GetTokens(ctx context.Context, in *GetTokensRequest, opts ...grpc.CallOption) (*TokensResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dfuse.zswhq.tokenmeta.v1.TokenMeta/GetTokens", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tokenMetaClient) GetAccountBalances(ctx context.Context, in *GetAccountBalancesRequest, opts ...grpc.CallOption) (*AccountBalancesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dfuse.zswhq.tokenmeta.v1.TokenMeta/GetAccountBalances", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tokenMetaClient) GetTokenBalances(ctx context.Context, in *GetTokenBalancesRequest, opts ...grpc.CallOption) (*TokenBalancesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dfuse.zswhq.tokenmeta.v1.TokenMeta/GetTokenBalances", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TokenMeta_GetTokens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dfuse.zswhq.tokenmeta.v1.TokenMeta/GetTokens",
	}
...
func _TokenMeta_GetAccountBalances_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dfuse.zswhq.tokenmeta.v1.TokenMeta/GetAccountBalances",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TokenMeta_GetTokenBalances_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dfuse.zswhq.tokenmeta.v1.TokenMeta/GetTokenBalances",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _TokenMeta_serviceDesc = grpc.ServiceDesc{
	ServiceName: "dfuse.zswhq.tokenmeta.v1.TokenMeta",
	...
	Metadata: "dfuse/zswhq/tokenmeta/v1/tokenmeta.proto",
}
