...
PROTO=${1:-"$ROOT/../proto"}
PROTO_EOSIO=${2:-"$ROOT/../proto-zswhq"}
...
function main() {
  ...
  generate "dfuse/zswhq/abicodec/v1/abicodec.proto"
  generate "dfuse/zswhq/codec/v1/codec.proto"
  generate "dfuse/zswhq/statedb/v1/" "statedb.proto" "tablet.proto" "singlet.proto"
  generate "dfuse/zswhq/trxdb/v1/trxdb.proto"
  generate "dfuse/zswhq/funnel/v1/funnel.proto"
  generate "dfuse/zswhq/search/v1/search.proto"
  generate "dfuse/zswhq/tokenmeta/v1/tokenmeta.proto"
  generate "dfuse/zswhq/accounthist/v1/accounthist.proto"
  ...
  echo "streamingfast/proto-zswhq revision: `GIT_DIR=$PROTO_EOSIO/.git git rev-parse HEAD`" >> $ROOT/pb/last_generate.txt
}
