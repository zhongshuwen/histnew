...
func TestABIChangeHandler_ProcessBlock(t *testing.T) {
	abiString1 := `{"version":"zswhq::abi/1.0","structs":[{"name":"struct_name_1","fields":[{"name":"struct_1_field_1","type":"string"}]}],"tables":[{"name":"table_name_1","index_type":"i64","key_names":["key_name_1"],"key_types":["string"],"type":"struct_name_1"}]}`
	abiString2 := `{"version":"zswhq::abi/2.0","structs":[{"name":"struct_name_1","fields":[{"name":"struct_1_field_1","type":"string"}]}],"tables":[{"name":"table_name_1","index_type":"i64","key_names":["key_name_1"],"key_types":["string"],"type":"struct_name_1"}]}`
	abiString3 := `{"version":"zswhq::abi/3.0","structs":[{"name":"struct_name_1","fields":[{"name":"struct_1_field_1","type":"string"}]}],"tables":[{"name":"table_name_1","index_type":"i64","key_names":["key_name_1"],"key_types":["string"],"type":"struct_name_1"}]}`
	...
	require.Equal(t, "zswhq::abi/1.0", handler.CurrentABI().Version)
	...
	require.NoError(t, err)
	require.Equal(t, "zswhq::abi/2.0", handler.CurrentABI().Version)
	...
	require.NoError(t, err)
	require.Equal(t, "zswhq::abi/3.0", handler.CurrentABI().Version)

}

func TestABIChangeHandler_ProcesswithError(t *testing.T) {
	abiString := `{"version":"zswhq::abi/1.0","structs":[{"name":"struct_name_1","fields":[{"name":"struct_1_field_1","type":"string"}]}],"tables":[{"name":"table_name_1","index_type":"i64","key_names":["key_name_1"],"key_types":["string"],"type":"struct_name_1"}]}`
	...
	blkWithBadABI := testBlock(t, "00000002a", "00000001a", "zswhq", 1, `{
		...
		"action_traces":[{
			...
			"action": {
				"account": "zswhq",
				"name": "setabi",
				"json_data": "{\"account\":\"zswhq\",\"abi\":\"bad.data.here\"}"
			}
		}]
	}`)
