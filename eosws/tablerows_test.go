...
import (
	...
	"github.com/zhongshuwen/histnew/eosws/wsmsg"
...
`))}},
			...
			abiForAccountName: &ABIAccountName{accountName: zsw.AccountName("account.1"), abiString: `{"version":"zswhq::abi/1.0","structs":[{"name":"struct_name_1","fields":[{"name":"struct_1_field_1","type":"string"}]}],"tables":[{"name":"table_name_1","index_type":"i64","key_names":["key_name_1"],"key_types":["string"],"type":"struct_name_1"}]}`},
