...
func init() {
	...
	logging.Register("github.com/zhongshuwen/histnew/mindreader_stdin", &appLogger)
	...
	launcher.RegisterApp(&launcher.AppDef{
		...
		Logger:      launcher.NewLoggingDef("github.com/zhongshuwen/histnew/mindreader_stdin$", []zapcore.Level{zap.WarnLevel, zap.WarnLevel, zap.InfoLevel, zap.DebugLevel}),
