...
func init() {
	...
	logging.Register("github.com/zhongshuwen/histnew/mindreader", &appLogger)
	...
	launcher.RegisterApp(&launcher.AppDef{
		...
		Logger: launcher.NewLoggingDef("github.com/zhongshuwen/histnew/mindreader$", []zapcore.Level{zap.WarnLevel, zap.WarnLevel, zap.InfoLevel, zap.DebugLevel}),
