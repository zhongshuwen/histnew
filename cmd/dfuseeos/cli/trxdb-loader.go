...
import (
	...
	trxdbLoaderApp "github.com/zhongshuwen/histnew/trxdb-loader/app/trxdb-loader"
...
func init() {
	launcher.RegisterApp(&launcher.AppDef{
		...
		Logger:      launcher.NewLoggingDef("github.com/zhongshuwen/histnew/(trxdb|trxdb-loader).*", nil),
