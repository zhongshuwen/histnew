...
import (
	...
	"github.com/zhongshuwen/histnew/filtering"
	pbcodec "github.com/zhongshuwen/histnew/pb/dfuse/zswhq/codec/v1"
	"github.com/spf13/cobra"
	"github.com/spf13/viper"
	"github.com/streamingfast/bstream"
	blockstreamv2 "github.com/streamingfast/bstream/blockstream"
...
func init() {
	...
	logging.Register("github.com/zhongshuwen/histnew/firehose", &appLogger)
	...
	launcher.RegisterApp(&launcher.AppDef{
		...
		Logger:      launcher.NewLoggingDef("github.com/zhongshuwen/histnew/firehose.*", nil),
