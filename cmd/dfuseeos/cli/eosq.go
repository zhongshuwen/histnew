...
import (
	eosqApp "github.com/zhongshuwen/histnew/eosq/app/eosq"
...
func init() {
	...
	launcher.RegisterApp(&launcher.AppDef{
		...
		MetricsID:   "eosq",
		Logger:      launcher.NewLoggingDef("github.com/zhongshuwen/histnew/eosq.*", nil),
		InitFunc:    nil,
		RegisterFlags: func(cmd *cobra.Command) error {
			...
			cmd.Flags().String("eosq-price-ticker-name", "ZSWCC", "The price ticker")
			return nil
		},
