...
func maybeCheckNodeosVersion() {
	...
	if err != nil {
		...
		cliErrorAndExit(dedentf(`
			...
			at https://github.com/zhongshuwen/histnew/blob/develop/DEPENDENCIES.md#dfuse-instrumented-zswhq-prebuilt-binaries
	...
	if !version.supportsDeepMindOneOf(12, 13) {
		...
		if strings.Contains(version.String(), "dm") {
			cliErrorAndExit(dedentf(`
				...
				Follow instructions at https://github.com/zhongshuwen/histnew/blob/develop/DEPENDENCIES.md#dfuse-instrumented-zswhq-prebuilt-binaries
