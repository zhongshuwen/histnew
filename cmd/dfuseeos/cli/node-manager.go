...
import (
	...
	"github.com/zhongshuwen/histnew/node-manager/superviser"
...
func init() {
	...
	logging.Register("github.com/zhongshuwen/histnew/node-manager", &appLogger)
	...
	launcher.RegisterApp(&launcher.AppDef{
		...
		MetricsID:   "producer",
		Logger:      launcher.NewLoggingDef("github.com/zhongshuwen/histnew/node-manager.*", []zapcore.Level{zap.WarnLevel, zap.WarnLevel, zap.InfoLevel, zap.DebugLevel}),
