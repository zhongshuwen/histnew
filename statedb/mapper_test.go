	...
	tests := []struct {
	...
	}{
		{
			...
			input: ct.Block(t, "00000001aa", ct.TrxTrace(t,
				ct.DBOp(t, "UPD", "zswhq/scope/table1/key1", "............1/............1", "data/data"),
			)),
			expectedRows: nil,
		},
		{
			...
			input: ct.Block(t, "00000001aa", ct.TrxTrace(t,
				ct.DBOp(t, "INS", "zswhq/scope/table1/key1", "/............1", "/d1"),
				ct.DBOp(t, "UPD", "zswhq/scope/table1/key2", "/............2", "/d2"),
			)),
			expectedRows: []string{
				`cst:zswhq:scope:table1:0000000000000001:key1 => {"payer":"1","data":"6431"}`,
				`cst:zswhq:scope:table1:0000000000000001:key2 => {"payer":"2","data":"6432"}`,
			},
		},
		{
			name: "two update, one sticks",
			input: ct.Block(t, "00000001aa", ct.TrxTrace(t,
				ct.DBOp(t, "UPD", "zswhq/scope/table1/key1", "............1/............1", "d0/d1"),
				ct.DBOp(t, "UPD", "zswhq/scope/table1/key1", "............1/............1", "d1/d2"),
			)),
			expectedRows: []string{
				`cst:zswhq:scope:table1:0000000000000001:key1 => {"payer":"1","data":"6432"}`,
			},
		},
		{
			name: "remove, take it out",
			input: ct.Block(t, "00000001aa", ct.TrxTrace(t,
				ct.DBOp(t, "REM", "zswhq/scope/table1/key1", "............1/", "d0/"),
			)),
			expectedRows: []string{
				`cst:zswhq:scope:table1:0000000000000001:key1 => {}`,
			},
		},
		{
			...
			input: ct.Block(t, "00000001aa", ct.TrxTrace(t,
				ct.DBOp(t, "UPD", "zswhq/scope/table1/key1", "............1/............1", "d0/d1"),
				ct.DBOp(t, "UPD", "zswhq/scope/table1/key1", "............1/............1", "d1/d2"),
				ct.DBOp(t, "REM", "zswhq/scope/table1/key1", "............1/", "d2/"),
			)),
			expectedRows: []string{
				`cst:zswhq:scope:table1:0000000000000001:key1 => {}`,
			},
		},
		{
			...
			input: ct.Block(t, "00000001aa", ct.TrxTrace(t,
				ct.DBOp(t, "UPD", "zswhq/scope/table1/key1", "............1/............1", "d0/d1"),
				ct.DBOp(t, "REM", "zswhq/scope/table1/key1", "............1/", "d1/"),
				ct.DBOp(t, "INS", "zswhq/scope/table1/key1", "/............1", "/d2"),
				ct.DBOp(t, "REM", "zswhq/scope/table1/key1", "............1/", "d2/"),
			)),
			expectedRows: []string{
				`cst:zswhq:scope:table1:0000000000000001:key1 => {}`,
		...
		},
		{
			...
			input: ct.Block(t, "00000001aa", ct.TrxTrace(t,
				ct.DBOp(t, "INS", "zswhq/scope/table1/key1", "............1/", "/d1"),
				ct.DBOp(t, "UPD", "zswhq/scope/table1/key1", "............1/............1/", "d1/d2"),
				ct.DBOp(t, "UPD", "zswhq/scope/table1/key1", "............1/............1", "d2/d3"),
				ct.DBOp(t, "REM", "zswhq/scope/table1/key1", "............1/", "d3/"),
			)),
			expectedRows: nil,
		},

		{
			...
			expectedEntries: []string{
				`abi:zswhq:fffffffffffffffe => {"rawAbi":"000000000000000000"}`,
			},
		},
		{
