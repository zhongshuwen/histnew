...
func Test_toFlatTree(t *testing.T) {
	...
	assert.Equal(t, zswhq.CreationFlatTree{
		zswhq.CreationFlatNode{0, -1, 0},
		zswhq.CreationFlatNode{1, 0, 1},
		zswhq.CreationFlatNode{2, 0, 2},
		zswhq.CreationFlatNode{3, 2, 4},
		zswhq.CreationFlatNode{4, 2, 6},
		zswhq.CreationFlatNode{5, 4, 7},
		zswhq.CreationFlatNode{6, 4, 8},
		zswhq.CreationFlatNode{7, 2, 5},
		zswhq.CreationFlatNode{8, 0, 3},
		zswhq.CreationFlatNode{9, -1, 9},
		zswhq.CreationFlatNode{10, 9, 10},
		zswhq.CreationFlatNode{11, 9, 11},
		zswhq.CreationFlatNode{12, 11, 13},
		zswhq.CreationFlatNode{13, 11, 14},
		zswhq.CreationFlatNode{14, 9, 12},
