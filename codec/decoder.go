...
func BlockDecoder(blk *bstream.Block) (interface{}, error) {
	...
	if block.Version > MAX_SUPPORTED_PBCODEC_VERSION {
		return nil, fmt.Errorf("future block formats not supported, this code supports dfuse.zswhq.codec.v1.Block version %d, received version %d", MAX_SUPPORTED_PBCODEC_VERSION, block.Version)
	}
