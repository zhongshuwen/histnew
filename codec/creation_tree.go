...
func toFlatTree(roots ...*node) zswhq.CreationFlatTree {
	var tree zswhq.CreationFlatTree
...
func _toFlatTree(root *node, parentIndex int, walkIndex *int) (tree zswhq.CreationFlatTree) {
