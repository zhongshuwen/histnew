					...
					zsw.AccountName("eoscanadadad"): {
						{
							...
							Asset: &zsw.ExtendedAsset{
								Asset:    generateTestAsset(100, "ZSWCC"),
					...
					zsw.AccountName("johndoemyhero"): {
						{
							Owner: zsw.AccountName("eoscanadadad"),
							Asset: &zsw.ExtendedAsset{
								Asset:    generateTestAsset(29371, "ZSWCC"),
								Contract: "zswhq.token",
							},
						},
					},
		...
		},
		{
			...
			expectOwnedAssets: []*OwnedAsset{
				...
				},
				{
					Owner: zsw.AccountName("eoscanadadad"),
					Asset: &zsw.ExtendedAsset{
						Asset:    generateTestAsset(138, "ZSWCC"),
						Contract: "zswhq.token",
					},
				},
			},
					...
					zsw.AccountName("johndoeonecoin"): {
						{
							...
							Asset: &zsw.ExtendedAsset{
								Asset:    generateTestAsset(23927, "ZSWCC"),
								Contract: "zswhq.token",
							},
						},
					},
			...
			expectOwnedAssets: []*OwnedAsset{
				{
					Owner: zsw.AccountName("eoscanadadad"),
					Asset: &zsw.ExtendedAsset{
						Asset:    generateTestAsset(300000100, "ZSWCC"),
						Contract: "zswhq.token",
					},
				},
				{
					...
					"eoscanadadad": {
						{
							Owner: zsw.AccountName("eoscanadadad"),
							Asset: &zsw.ExtendedAsset{
								Asset:    generateTestAsset(20, "ZSWCC"),
								Contract: zsw.AccountName("zswhq.token"),
							},
						},
					},
					...
					"eoscanadadad": {
						{
							Owner: zsw.AccountName("eoscanadadad"),
							Asset: &zsw.ExtendedAsset{
								Asset:    generateTestAsset(30, "ZSWCC"),
	...
	tests := []struct {
	...
	}{
		{
			...
			asset: &OwnedAsset{
				Owner: zsw.AccountName("eoscanadadad"),
				Asset: &zsw.ExtendedAsset{
					Asset:    generateTestAsset(0, "ZSWCC"),
					Contract: zsw.AccountName("zswhq.token"),
				},
			},
			tokens: map[zsw.AccountName][]*pbtokenmeta.Token{
...
func TestDefaultCache_setToken(t *testing.T) {
	asset := generateTestAsset(1000000, "ZSWCC")
	biggerAsset := generateTestAsset(20000000, "ZSWCC")
	tests := []struct {
		name         string
