...
func Test_SortTokensSymbolAlpha(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			order: ASC,
			tokens: []*pbtokenmeta.Token{
				{Contract: "zswhq.token", Symbol: "ZSWCC", Holders: 8},
...
func Test_compareTokenBySymbol(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			order:       ASC,
			a:           &pbtokenmeta.Token{Contract: "zswhq.token", Symbol: "ZSWCC", Holders: 8},
		...
		},
		{
			...
			b:           &pbtokenmeta.Token{Contract: "zswhq.token", Symbol: "ZSWCC", Holders: 8},
			expectValue: false,
		},
		{
...
func Test_compareTokenByContract(t *testing.T) {
	tests := []struct {
		...
		},
		{
			name:        "descending a after b",
			order:       DESC,
			a:           &pbtokenmeta.Token{Contract: "bonecoin.en", Symbol: "ZSWCC", Holders: 8},
			b:           &pbtokenmeta.Token{Contract: "zswhq.token", Symbol: "WAL", Holders: 8},
			expectValue: false,
		},
		{
...
func Test_compareTokenByHolders(t *testing.T) {
	tests := []struct {
		...
		},
		{
			name:        "descending a after b",
			order:       DESC,
			a:           &pbtokenmeta.Token{Contract: "zswhq.token", Symbol: "ZSWCC", Holders: 3},
			b:           &pbtokenmeta.Token{Contract: "bonecoin.en", Symbol: "WAL", Holders: 8},
			expectValue: false,
		},
		{
